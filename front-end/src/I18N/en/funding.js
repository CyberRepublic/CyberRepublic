export default {
  hero: {
    ...
    description: `If you plan to use Elastos' core tech in your DApp or project, you can apply for funds from the Elastos ecosystem DAO - Elastos DAO.`
  },
  ...
  partOne: {
    ...
    step0: `1. Create a Suggestion on Elastos.com`,
  ...
  partTwo: {
    title: `Adding a funding Suggestion to Elastos DAO`,
    p1: `As the Elastos ecosystem DAO, Elastos DAO (DAO) supports Elastos' third tier of consensus via a unique proposal model. DAO is headed by a 12-party council that is elected annually by ELA tokenholders, but everyone in the Elastos ecosystem is eligible and encouraged to participate in the proposal process.`,
    p2: `Although community members cannot submit a proposal directly, they may submit prospective drafts called suggestions. When a suggestion picks up traction in the community, a council member may nominate the suggestion and transition it to a proposal. At this stage, the entire Elastos Council votes on the proposal to determine whether to carry out its contents and disburse the requested funding allocations.`,
    ...
    p5: `Congratulations - you have just submitted a suggestion to the Elastos DAO! To help your suggestion pick up traction, share your suggestion link on social media and in Elastos' official channels below:`,
    p6: `Watch Kiran from Tuum Tech explain what happens after you create a Suggestion on Elastos DAO as your Suggestion goes through the PoI Proposal Process.`
  },
  join: `Join the DAO Community`
}
