export default {
  ...
  crc: {
    ...
    explanation: `Elastos DAO (DAO) is the community that has naturally formed around Elastos. DAO consists of ELA token holders, Elastos Foundation members, Elastos ecosystem partners, and any other teams and individuals that contribute to developing Elastos’ technologies and community.`,
    list: {
      1: {
        date: 'August 2018',
        text: `At the Elastos First Anniversary Event, 16 million ELA was transferred to Elastos DAO (DAO).`
      },
      2: {
        date: 'December 2018',
        text: `The first draft of the DAO Constitution was submitted for community review`,
        link: 'read it here'
      },
      3: {
        date: 'February 2019',
        text: `Further refinements to the Elastos Council were made giving the community a way to propose Suggestions and the Council to fund projects. You can read more about the funding workflow at`,
    ...
    flow: {
      ...
      submitProposal: 'Submit Proposal to the DAO Website',
      council: 'Elastos Council',
      proposalPage: 'DAO Proposal Page',
      approvedProposal: 'Approved Proposal',
      voting: 'Voting'
    },
    regionalComm: 'DAO REGIONAL COMMUNITY'
  }
}
