export default {
  ...
  '4': {
    ...
    body: `
      <p>The goal of PoW and BPoS consensus is to securely and effectively record transactions on a blockchain ledger. Comparatively, the objective of CRC is to make community decisions using a consensus mechanism which draws on humans rather than computers and machines. Simply put, the CRC is a consensus mechanism in which humans - in particular, ELA holders - act as nodes, both by submitting proposals and voting on their outcomes to carry out community governance.</p>
      <p>The problem here is that purely on-chain consensus mechanisms like BPoS or PoW have a very clear objective: record transactions and blocks on the blockchain. But the objective of the CRC is not necessarily clearly defined because "community affairs" are often broad and ambiguous, and thus decisions must be made by human beings.</p>
      ...
      <p>The CRC’s democratic form of consensus is analogous to BPoS, where delegate elections can be likened to Supernode elections: humans vote to elect Council members based on their ELA tokenholdings, and utilize the blockchain as a trustless implementation mechanism. With regard to their functionalities, the greatest difference between the CRC Delegates and BPoS Supernodes is that CRC delegates are imbued with the power to raise and recommend community proposals at will.</p>
  ...
  '10': {
    ...
    body: `
      <p>CRC not only is a consensus-based community governance mechanism, but is one of the most important pieces of infrastructure in the Elastos ecosystem. Together with PoW and BPoS, it lays a strong foundation for truly decentralized applications and services.</p>
  ...
  B: {
    ...
    body: `
      ...
      <p>The CRC whitepaper is currently maintained by the CR Council and Secretariat Team. The workgroup can be reached via email at secretariat@cyberrepubli.org, and any suggestions pertaining to the whitepaper should be forwarded to this email address.</p>
